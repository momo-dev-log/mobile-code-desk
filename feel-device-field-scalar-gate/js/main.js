/* =========================================================================
 * 感触装置 — scalar core gate test (独立ページ)
 *
 ...
 *
 * このページは既存の feel-device-field/ とは完全に独立した別ページであり、
 * lag/soften/seq(F.1)/tail(F.2)/drift等は一切持たない。
 * ========================================================================= */
...
const TAG = '[feel-device-field-scalar-gate]';
